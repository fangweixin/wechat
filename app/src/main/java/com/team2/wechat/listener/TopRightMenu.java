...
public class TopRightMenu {
    ...
    private void init() {
        ...
        Log.d(TAG, "初始化02");
        //填充布局时出错
        content = layoutInflater.inflate(R.layout.trm_popup_menu, null);
        Log.d(TAG, "初始化03");
     ...
     * @return
     */
    public TopRightMenu addMenuItem(MyMenuItem item){
     ...
     * @return
     */
    public TopRightMenu addMenuList(List<MyMenuItem> list){
